...
const ProcessingType = () => {
    ...
    const fetchRecords = useCallback(async () => {
        ...
        try {
            ...
            const mockData = [
                { id: 1, harvest_id: 'H-2024-001', type: 'Washed', method: 'Wet Processing', date: '2024-01-16' },
                { id: 2, harvest_id: 'H-2024-002', type: 'Natural', method: 'Dry Processing', date: '2024-01-15' },
            ];
            setRecords(mockData);
        } catch (error) {
            ...
            <main className="p-4 sm:p-6 md:p-8 pt-0">
                ...
                <div className="flex justify-between items-center mb-8">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">Configure processing methods and types</p>
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                    <KPICard
                        ...
                        subtitle="Processing type assignments"
                        icon={Settings}
                        loading={loading}
                    />
                    <KPICard
                        title="Latest Record"
                        value={records.length > 0 ? records[0].harvest_id : 'N/A'}
                        subtitle="Most recent assignment"
                        icon={Coffee}
                        loading={loading}
                    />
                </div>
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead style={{ backgroundColor: CoffeeColors.LIGHT_BG }}>
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-left text-xs font-semibold uppercase text-gray-700">Processing Type</th>
                                    <th className="px-6 py-3 text-left text-xs font-semibold uppercase text-gray-700">Method</th>
                                ...
                                {loading ? (
                                    ...
                                    records.map((record) => (
                                        <tr key={record.id} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4 text-gray-700">{record.method}</td>
