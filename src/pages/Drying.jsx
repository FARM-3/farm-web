                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead style={{ backgroundColor: CoffeeColors.LIGHT_BG }}>
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-center text-xs font-semibold uppercase text-gray-700">Duration</th>
                                    <th className="px-6 py-3 text-center text-xs font-semibold uppercase text-gray-700">Moisture Level</th>
                            ...
                            <tbody className="bg-white divide-y divide-gray-100">
                                {loading ? (
                                    ...
                                    <tr>
                                        <td colSpan="6" className="px-6 py-12 text-center text-gray-500">No drying records found</td>
                                    </tr>
                                ) : (
                                    records.map((record) => (
                                        <tr key={record.id} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4 text-center text-gray-700">{record.duration}</td>
                                            <td className="px-6 py-4 text-center text-gray-700">{record.moisture_level}</td>
