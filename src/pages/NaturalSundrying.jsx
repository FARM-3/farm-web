...
const NaturalSundrying = () => {
    ...
    const fetchRecords = async (url = API_ENDPOINTS.NATURAL_SUNDRYING) => {
        setLoading(true);
        setError(null);
        try {
    ...
    // Since natural sundrying schema doesn't have end_date or days, all records are considered active
            ...
            <main className="p-4 sm:p-6 md:p-8 pt-0">
                ...
                <div className="flex justify-between items-center mb-8">
                    <div>
                        <h1 className="text-3xl font-bold flex items-center gap-3" style={{ color: CoffeeColors.DARK_BROWN }}>
                            <Sun size={32} style={{ color: CoffeeColors.BUTTON_BROWN }} />
                            Natural Sundrying
                        </h1>
                        <p className="text-gray-600 mt-1">Track natural sundrying operations and conditions</p>
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                    <KPICard
                        ...
                        subtitle="All sundrying records"
                        icon={Sun}
                        loading={loading}
                    />
                    <KPICard
...
export default NaturalSundrying;
