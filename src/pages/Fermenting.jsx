                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead style={{ backgroundColor: CoffeeColors.LIGHT_BG }}>
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-center text-xs font-semibold uppercase text-gray-700">End Date</th>
                            ...
                            <tbody className="bg-white divide-y divide-gray-100">
                                {loading ? (
                                    ...
                                    <tr>
                                        <td colSpan="8" className="px-6 py-12 text-center text-gray-500">No fermenting records found</td>
                                    </tr>
                                ) : (
                                    records.map((record, index) => {
                                        ...
                                        return (
                                            <tr key={record.processing_id || index} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-6 py-4 text-center text-gray-700">{record.days || 0}</td>
                                                ...
                                                <td className="px-6 py-4 text-center text-gray-700">{record.end_date || '-'}</td>
