...
const Fermenting = () => {
    ...
    const fetchRecords = async (url = API_ENDPOINTS.FERMENTING) => {
        setLoading(true);
        setError(null);
        try {
            ...
            console.error('Error fetching fermenting records:', error);
    ...
    const inProgressCount = records.filter(r => !r.end_date).length;
    const completedCount = records.filter(r => r.end_date).length;
            ...
            <main className="p-4 sm:p-6 md:p-8 pt-0">
                ...
                <div className="flex justify-between items-center mb-8">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">Monitor and manage fermenting operations</p>
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                    <KPICard
                        ...
                        subtitle="All fermenting records"
                        icon={Sparkles}
                        loading={loading}
                    />
                    <KPICard
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead style={{ backgroundColor: CoffeeColors.LIGHT_BG }}>
                                <tr>
                                    ...
                                    <th className="px-3 py-2 text-center text-xs font-semibold uppercase text-gray-700">Days</th>
                                    ...
                                    <th className="px-3 py-2 text-center text-xs font-semibold uppercase text-gray-700">End Date</th>
                            ...
                            <tbody className="bg-white divide-y divide-gray-100">
                                {loading ? (
                                    ...
                                    <tr>
                                        <td colSpan="8" className="px-3 py-6 text-center text-gray-500">No fermenting records found</td>
                                    </tr>
                                ) : (
                                    records.map((record, index) => {
                                        const status = record.end_date ? 'Completed' : 'In Progress';
                                        return (
                                            <tr key={record.processing_id || index} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-3 py-2 text-center text-gray-700 text-sm whitespace-nowrap">{record.days || 0}</td>
                                                ...
                                                <td className="px-3 py-2 text-center text-gray-700 text-sm whitespace-nowrap">{record.end_date || '-'}</td>
