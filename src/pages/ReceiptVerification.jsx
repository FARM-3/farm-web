        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full">
          ...
          <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded">
            <p className="text-sm text-red-800">
              <strong>Important:</strong> This receipt could not be verified. Please contact FARM FMIS directly to confirm its authenticity.
            </p>
          </div>
        ...
        <div className="bg-gray-50 p-6 m-6 rounded-lg">
          <div>
            ...
            <p className="text-gray-700">
              This receipt was issued by FARM FMIS on <strong>{issuedDate}</strong>.
            </p>
