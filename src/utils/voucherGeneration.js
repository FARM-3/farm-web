    ...
    ">
      ...
      <div style="margin-bottom: 25px;">
        <div style="display: flex; justify-content: space-between; align-items: start; border-bottom: 2px solid #702A0B; padding-bottom: 15px;">
          <div style="display: flex; align-items: center; gap: 15px;">
            ${logoDataURL ? `<img src="${logoDataURL}" alt="FARM FMIS Logo" style="width: 60px; height: 60px; object-fit: contain;" />` : ''}
            <div>
              <h1 style="color: #702A0B; margin: 0 0 5px 0; font-size: 24px; font-weight: 700; letter-spacing: 0.5px;">FARM FMIS</h1>
      ...
      <div style="margin-top: 40px; padding-top: 20px; border-top: 2px solid #702A0B;">
        ...
        <div style="text-align: center; color: #666; font-size: 11px;">
          <p style="margin: 5px 0;">This is an official payment voucher generated by FARM FMIS system</p>
  ...
  return `
    ...
    ">
      ...
      <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 25px; border-bottom: 2px solid #702A0B; padding-bottom: 15px;">
        <div style="display: flex; align-items: center; gap: 15px;">
          <div>
            <h1 style="color: #702A0B; margin: 0 0 5px 0; font-size: 28px; font-weight: 700; letter-spacing: 0.5px;">FARM FMIS</h1>
